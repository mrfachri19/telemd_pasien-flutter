...
class ListInboxImpl implements ListInboxRepository {
  ...
  @override
  Future<Either<Failure, List<ListInboxModel>?>> getListInbox() async {
    if (await networkInfo.isConnected) {
      try {
        final remoteData = await remoteDataSource.getListInbox();
